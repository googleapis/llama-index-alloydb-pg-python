...
from .async_document_store import AsyncAlloyDBDocumentStore
from .engine import AlloyDBEngine


class AlloyDBDocumentStore(BaseDocumentStore):
    ...
    def __init__(
        ...
        document_store: AsyncAlloyDBDocumentStore,
    ):
        ...
        """
        if key != AlloyDBDocumentStore.__create_key:
            raise Exception(
    ...
    async def create(
        ...
        """
        coro = AsyncAlloyDBDocumentStore.create(
