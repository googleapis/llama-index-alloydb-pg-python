...
from llama_index_alloydb_pg import AlloyDBDocumentStore, AlloyDBEngine
...
class TestAlloyDBDocumentStoreAsync:
...
@pytest.mark.asyncio(loop_scope="class")
class TestAlloyDBDocumentStoreSync:
    @pytest.fixture(scope="module")
    def db_project(self) -> str:
        return get_env_var("PROJECT_ID", "project id for google cloud")
    ...
    async def sync_doc_store(self, sync_engine):
        ...
        sync_doc_store = AlloyDBDocumentStore.create_sync(
